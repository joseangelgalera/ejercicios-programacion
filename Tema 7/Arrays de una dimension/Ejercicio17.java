 ...
 * quede situado en la posición 0 del array. Por último, se mostrará el array 
 * rotado por pantalla.
 */
package tema.pkg7;
...
public class Ejercicio17 {
  ...
  public static void main(String[] args) {
      ...
      for (int i = 0; i <= (numeros.length - 1); i++) {
        ...
        switch (j) {
          ...
          case 4:
            ...
            if (longitud > Integer.toString(numeros[i]).length()) {
              System.out.print(" ");
            }
            if (i == (numeros.length - 1)) {
              System.out.print("│");
    ...
    int numero;
    do {
      System.out.print("\n¿Qué número de la tabla desea que aparezca en la "
              + "primera posición?: ");
      numero = s.nextInt();
      for (int i = 0; i <= (numeros.length - 1); i++) {
        if (numero == numeros[i]) {
    ...
    System.out.println("\nTras rotar la tabla para que el numero " + numero
            + " quede en la primera "
