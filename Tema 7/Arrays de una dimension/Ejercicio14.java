...
public class Ejercicio14 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\n La tabla original con las palabras que ha "
            + "introducido queda así: ");
    ...
    String[] arrayAux = new String[palabras.length];
    int posAux = 0;
    ...
    System.out.println("\nTras mover las palabras que son colores al inicio de "
            + "la tabla, esta "
            + "queda así: ");
